...
public class Find {
    ...
    static List<Integer> findMatchedStringsIndices(List<String> allData, List<Integer> subsetIndices, String criteria) {
    ...
    static int findLargestYearIndex(List<String> allData, List<Integer> subsetIndices) throws InvalidDateStringException {
        int largestIndex = subsetIndices.get(0);
    ...
    static int findSmallestYearIndex(List<String> allData, List<Integer> subsetIndices) throws InvalidDateStringException {
        int smallestIndex = subsetIndices.get(0);

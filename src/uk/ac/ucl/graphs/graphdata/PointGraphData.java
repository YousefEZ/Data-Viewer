...
public class PointGraphData extends GraphData{

    private List<Double> xValues;
    private List<Double> yValues;

    public PointGraphData(String horizontalLabel, String verticalLabel, List<String> xValues, List<String> yValues){
    ...
    private static List<Double> convertListStringToDouble(List<String> values){
        ...
        for (String value: values){
            valuesInDouble.add(Double.valueOf(value));
        }

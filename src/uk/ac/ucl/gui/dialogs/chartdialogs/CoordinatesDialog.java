package uk.ac.ucl.gui.dialogs.chartdialogs;
...
public class CoordinatesDialog extends JDialog {
    ...
    public CoordinatesDialog(JFrame frame, List<String> columns){
        super(frame, true);
    ...
    private void setupFrame() {
        setSize(300, 125);
        setTitle("Create Coordinates Chart");
    ...
    private void initComponents(){
        submit = new JButton("Create Chart");
